...
class ProductViewCarosil extends StatefulWidget {
  ...
  @override
  _ProductViewCarouselState createState() => _ProductViewCarouselState();
}

class _ProductViewCarouselState extends State<ProductViewCarosil> {
            ...
            children: widget.productImages.asMap().entries.map((entry) {
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color:
                      _currentImageIndex == entry.key ? Colors.red : Colors.grey,
                ),
              );
            }).toList(),
          ),
